...
ax1.bar(x=Names, height=APY, label=('x', 'y'))
ax2.bar(x=Names, height=ASTDV, label=('x', 'y'))
ax1.set_title('$APY$')
...
ax.bar(x=Names, height=APY)
ax.bar(x=Names, height=ASTDV)
...
ax.bar(x=Names, height=relAPY_ASTDV)
ax.bar(x=Names, height=relAPY_MDD)
